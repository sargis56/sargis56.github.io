...
(function() {
    ...
    assetManifest = [                               // Array of objects. Key-value pairs
        ...
        {id: "backButton", src:"./Assets/Images/backBut.png"},
        {id: "logoSprite", src:"./Assets/Images/logo_4.png"},
        {id: "playerSprite", src:"./Assets/Images/player.png"},
        {id: "backgroundSprite", src:"./Assets/Images/background.jpg"},

        {id: "startBackGroundSprite", src:"./Assets/Images/startBackGround.jpg"},

        {id: "rockSprite", src:"./Assets/Images/wall.png"},
        {id: "endSprite", src:"./Assets/Images/endpoint.png"},
        {id: "startSprite", src:"./Assets/Images/startpoint.png"},

        {id: "endBackgroundSprite", src:"./Assets/Images/endScreen.png"},
