module scenes {
    export class Level1Scene extends objects.Scene {
        ...
        private boxSprite6: objects.GameSprite;
        ...
        private healthUPSprite4: objects.GameSprite;
        private healthUPSprite5: objects.GameSprite;
        ...
        private decayHealthAmount: number  = 0.0007; //0.0005;
